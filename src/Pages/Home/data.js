...
export const packages = [
  ...
  {
    title: 'Maternity Glow Package',
    price: '$900',
    coverageHours: '2 Hours',
    photographers: '1 Photographer',
    editedPhotos: '50 Photos',
    deliveryTime: '2 Weeks',
    extras: 'Digital Gallery, Maternity Photo Book',
    sessionLocation: 'Studio or Outdoor',
    description: 'Celebrate the beauty of pregnancy with a serene and elegant maternity photography session, capturing the anticipation of your growing family.',
    servicesIncluded: ['Photography'],
    isPopular: false,
    icon: 'https://res.cloudinary.com/djeorsh5d/image/upload/v1758593277/SnapInsta.to_515485992_18509616034055684_8373133984578600666_n_xtudoq.jpg',
  },
]

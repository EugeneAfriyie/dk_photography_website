...
const Header = ({mobileMenuOpen,setMobileMenuOpen}) => {
  return (
        ...
        <>
             <header className="shadow-2xl shadow-gray-600  fixed top-0 left-1/2 transform -translate-x-1/2 w-full sm:w-[70%] z-500 bg-black/70 backdrop-blur-md rounded-full">

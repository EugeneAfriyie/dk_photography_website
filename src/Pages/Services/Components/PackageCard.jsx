    ...
    <div className="scroll-container overflow-x-auto whitespace-nowrap flex hide-scrollbar scroll-smooth">
      <div className="auto-scroll flex gap-6 px-4">
        {[...packages, ...packages].map((pkg, index) => (
          <div
            key={`${pkg.title}-${index}`}
            className={`min-w-[300px] sm:w-[350px] flex-shrink-0 group flex flex-col justify-between overflow-hidden bg-gray-800 p-6 rounded-lg shadow-lg ${
          ...
          >
            ...
            <p className="text-gray-400 text-sm mb-4 break-words">{pkg.description}</p>
            <a
              href="/contact"
